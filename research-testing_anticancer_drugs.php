  ...
  <header class="header header-extra-restrictions">
    ...
    <div class="container" class="main-info-background">
      <div class="main-info-research">
        <h1 class="new-opinion">Testing anticancer drugs</h1>
      </div>
    </div>
  </header>
  <main>
  	<div class="container research-text">
      <p>We use MTS and MTT methodologies for testing <b>anticancer drugs</b>. </p> 
      <p>We perform tests in the laboratory of nanobiotechnologies in St Petersburg Academic University.</p>
      <div class="align-center">
        <img class="img-info" src="image/research/testing_anticancer_drugs.jpg" alt="Testing anticancer drugs"> 
      </div>
    </div>
  </main>
